  ...
  <div class="container mt-5">
    <div class="row">
      <div class="mx-auto text-center mb-5">
        ...
        <audio id="audio-surah"
          src="https://equran.nos.wjv-1.neo.id/audio-full/Misyari-Rasyid-Al-Afasi/110.mp3"></audio>
        <div class="d-flex justify-content-center">
          <button class="btn btn-dark btn-sm mr-2" onclick="playAudioSurah()"><i class="fa-solid fa-play"></i>
    ...
    <div class="row_ayat" v-for="ayat in dataSurah.ayat">
      ...
      <div class="d-flex justify-content-between align-items-start">
        <div class="text-center">
          ...
          <span data-toggle="tooltip" data-placement="right" title="Tafsir"><i
              class="fa-regular fa-eye mt-3 text-muted tafsir" data-toggle="modal"
              :data-target="'#exampleModal' + ayat.nomorAyat"></i></span>
        </div>
        <div class="audio-container">
          <audio :id="'audio-ayat-'+ayat.nomorAyat"
            :src="ayat.audio['05']"></audio>
